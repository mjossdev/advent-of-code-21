private class BingoGame(private val numbers: List<Int>, participants: List<BingoParticipant>) {
...
private class BingoParticipant(board: List<List<Int>>) {
    var score: Int = 0
        private set
...
private data class BingoField(val number: Int, var marked: Boolean = false)

private fun parseBoard(lines: List<String>): List<List<Int>> {
    check(lines.size == 5)
    return lines.map { l ->
...
private fun createBingoGame(input: List<String>): BingoGame {
